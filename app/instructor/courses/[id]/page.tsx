          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-xs sm:text-sm text-gray-600">
            <div className="flex items-center">
              ...
              <span className="whitespace-nowrap">
                Created: {course.createdAt ? new Date(course.createdAt).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' }) : 'N/A'}
              </span>
            </div>
            <div className="flex items-center">
              <span className="mr-1 sm:mr-2">🔄</span>
              <span className="whitespace-nowrap">
                Updated: {new Date(course.lastUpdated).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
              </span>
            </div>
            <div className="flex items-center">
              <img
            ...
            <div className="flex items-center">
              ...
              <span className="text-gray-600">{course.rating} ({course.reviewCount} reviews)</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
              <div className="bg-white rounded-lg border border-gray-200 p-4 text-center">
                ...
                <div className="text-2xl font-bold text-gray-900">{course.studentCount.toLocaleString()}</div>
            ...
            <section className="mb-6 sm:mb-8 bg-white rounded-lg border border-gray-200 p-6">
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                ...
                {course.subCategory && (
                  <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded text-sm">{course.subCategory}</span>
                )}
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded text-sm">{course.level}</span>
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded text-sm">{course.language}</span>
              </div>
            </section>
            ...
            {/* Course Information */}
            <section className="mb-6 sm:mb-8 bg-white rounded-lg border border-gray-200 p-6">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">Course Information</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <span className="text-sm text-gray-600">Level:</span>
                  <span className="ml-2 font-semibold text-gray-900">{course.level}</span>
                </div>
                <div>
                  <span className="text-sm text-gray-600">Duration:</span>
                  <span className="ml-2 font-semibold text-gray-900">{course.duration}</span>
                </div>
                <div>
                  <span className="text-sm text-gray-600">Language:</span>
                  <span className="ml-2 font-semibold text-gray-900">{course.language}</span>
                </div>
                <div>
                  <span className="text-sm text-gray-600">Last Updated:</span>
                  <span className="ml-2 font-semibold text-gray-900">
                    {new Date(course.lastUpdated).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
                  </span>
                </div>
                {course.createdAt && (
                  <div>
                    ...
                    <span className="ml-2 font-semibold text-gray-900">
                      {new Date(course.createdAt).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
                    </span>
                  </div>
                )}
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-gray-900 font-semibold capitalize">{course.level.toLowerCase()}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <span className="text-gray-600 mr-2">📚</span>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-gray-900 font-semibold">{totalSections}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <span className="text-gray-600 mr-2">👥</span>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-gray-900 font-semibold">{course.rating} / 5.0</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <span className="text-gray-600 mr-2">💬</span>
                    ...
                    <span className="text-gray-900 font-semibold">{course.reviewCount}</span>
                  </div>
                </div>
              </div>
